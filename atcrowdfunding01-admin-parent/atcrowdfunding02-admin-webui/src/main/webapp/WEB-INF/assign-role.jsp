                ...
                <div class="panel-body">
                    <form action="assign/do/role/assign.html" method="post" role="form" class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <select id="exampleInputPassword1" class="form-control" multiple="" size="10" style="width:100px;overflow-y:auto;">
                        ...
                        <div class="form-group">
                            <ul>
                                ...
                                <br>
                                <li class="btn btn-default glyphicon" style="margin-top: 20px;"><button id="submitBtn" type="submit" class="btn btn-sm btn-success btn-block">保存</button></li>
                            </ul>
                        </div>
